...
$args = array(
    ...
    'menu_title'                => esc_html__( 'Theme Options', 'twentytwentyone' ),

    // The text to appear on the page title.
    'page_title'                => esc_html__( 'Theme Options', 'twentytwentyone' ),
...
$args['admin_bar_links'][] = array(
    'id'    => 'redux-docs',
    'href'  => '//devs.redux.io/',
    'title' => __( 'Documentation', 'twentytwentyone' ),
);

$args['admin_bar_links'][] = array(
    'id'    => 'redux-support',
    'href'  => '//github.com/ReduxFramework/redux-framework/issues',
    'title' => __( 'Support', 'twentytwentyone' ),
);

$args['admin_bar_links'][] = array(
    'id'    => 'redux-extensions',
    'href'  => 'redux.io/extensions',
    'title' => __( 'Extensions', 'twentytwentyone' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
    ...
    $args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'twentytwentyone' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
    $args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'twentytwentyone' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'twentytwentyone' ) . '</p>';
...
$help_tabs = array(
    array(
        'id'      => 'redux-help-tab-1',
        'title'   => esc_html__( 'Theme Information 1', 'twentytwentyone' ),
        'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'twentytwentyone' ) . '</p>',
    ),
    array(
        'id'      => 'redux-help-tab-2',
        'title'   => esc_html__( 'Theme Information 2', 'twentytwentyone' ),
        'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'twentytwentyone' ) . '</p>',
    ),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'twentytwentyone' ) . '</p>';
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Basic Fields', 'twentytwentyone' ),
        'id'               => 'basic',
        'desc'             => esc_html__( 'These are really basic fields!', 'twentytwentyone' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Editors', 'twentytwentyone' ),
        'id'               => 'editor',
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Color Selection', 'twentytwentyone' ),
        'id'    => 'color',
        'icon'  => 'el el-brush',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Design Fields', 'twentytwentyone' ),
        'id'    => 'design',
        'icon'  => 'el el-wrench',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Media Uploads', 'twentytwentyone' ),
        'id'    => 'media',
        'icon'  => 'el el-picture',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Presentation Fields', 'twentytwentyone' ),
        'id'    => 'presentation',
        'icon'  => 'el el-screen',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Switch / Button Set', 'twentytwentyone' ),
        'id'    => 'switch_buttonset',
        'icon'  => 'el el-cogs',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Select Fields', 'twentytwentyone' ),
        'id'    => 'select',
        'icon'  => 'el el-list-alt',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Slider / Spinner', 'twentytwentyone' ),
        'id'    => 'slider_spinner',
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Additional Types', 'twentytwentyone' ),
        'id'    => 'additional',
        'icon'  => 'el el-magic',
    )
);
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Advanced Features', 'twentytwentyone' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__( 'Disabling', 'twentytwentyone' ),
        'icon'  => 'el el-lock',
    )
);
...
if ( class_exists( 'Redux_Pro' ) ) {
    Redux::set_section(
        $opt_name,
        array(
            'title' => esc_html__( 'Redux Pro Fields', 'twentytwentyone' ),
            'id'    => 'redux-pro-fields',
            'icon'  => 'el el-redux',
            'class' => 'pro_highlight',
            'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'twentytwentyone' ) . '<a href="https://devs.redux.io/premium/" target="_blank">https://devs.redux.io/premium/</a>',
        )
    );
...
if ( file_exists( $dir . '/../README.md' ) ) {
    $section = array(
        'icon'   => 'el el-list-alt',
        'title'  => esc_html__( 'Documentation', 'twentytwentyone' ),
        'fields' => array(
            array(
...
Redux::set_section(
    ...
    array(
        'icon'            => 'el el-list-alt',
        'title'           => esc_html__( 'Customizer Only', 'twentytwentyone' ),
        'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'twentytwentyone' ) . '</p>',
        'customizer_only' => true,
        'fields'          => array(
            array(
                'id'              => 'opt-customizer-only',
                'type'            => 'select',
                'title'           => esc_html__( 'Customizer Only Option', 'twentytwentyone' ),
                'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'twentytwentyone' ),
                'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'twentytwentyone' ),
                'customizer_only' => true,
                'options'         => array(
                    '1' => esc_html__( 'Opt 1', 'twentytwentyone' ),
                    '2' => esc_html__( 'Opt 2', 'twentytwentyone' ),
                    '3' => esc_html__( 'Opt 3', 'twentytwentyone' ),
                ),
                'default'         => '2',
            ),
        ),
...
if ( ! function_exists( 'dynamic_section' ) ) {
    ...
    function dynamic_section( array $sections ): array {
        $sections[] = array(
            'title'  => esc_html__( 'Section via hook', 'twentytwentyone' ),
            'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'twentytwentyone' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
    ...
    function change_defaults( array $defaults ): array {
        $defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'twentytwentyone' );
